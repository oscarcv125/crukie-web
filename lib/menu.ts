...
export const cookies: Cookie[] = [
  {
    ...
    ingredients: ["masa base premium", "chispas de chocolate semi-amargo premium"],
  ...
  },
  {
    ...
    ingredients: ["masa base premium", "Nutella de avellana"],
  ...
  },
  {
    ...
    ingredients: ["masa base premium", "chispas de chocolate", "galleta Oreo troceada"],
    tags: ["cookies & cream"],
  ...
  },
  {
    ...
    ingredients: ["masa base premium", "chispas de chocolate", "crema Biscoff Lotus", "galleta Lotus troceada"],
  ...
  },
  {
    ...
    ingredients: ["masa base premium", "mantequilla de cacahuate natural"],
  ...
  },
  {
    ...
    ingredients: ["masa base premium", "chispas de chocolate", "chocolate Kinder troceado"],
